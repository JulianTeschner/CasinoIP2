...
Ihr könnt zum Beispiel über MongoDB Compass auf die DB zugreifen über die URI: mongodb://root:password@localhost:27017/?authSource=admin&readPreference=primary&directConnection=true&ssl=false 
